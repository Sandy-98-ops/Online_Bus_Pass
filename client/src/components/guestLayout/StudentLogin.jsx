    ...
    const handleLoginSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                cookies.set('studentData',
                    JSON.stringify(student), { path: '/' })

                navigate('/student'); // Redirect to admin layout
            ...
            <Container className='container-2'>
                ...
                <div className="form form-1">
                    ...
                    <Form onSubmit={handleLoginSubmit}>
                        ...
                        <Link to="/studentForgotPassword" className="forgot-password d-block mb-3">
                            Forgotten password?
                        </Link>
                        <hr />
